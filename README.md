...
# Z 工坊像素圆体 16px / Z Labs RoundPix 16px
...
本项目处于开发阶段，目前支持 GB/T 2312 所有汉字、常用西文及常用标点符号，可满足多数简体中文汉字使用需求。

> [!WARNING]
> 
> 此字体仍处于开发与调整阶段，目前存在中宫不均匀、汉字部件不一致等问题，敬请谅解。
> 
...
&nbsp;&nbsp;&nbsp;&nbsp;🚧 Big5 常用汉字表（3472 / 5401）

&nbsp;&nbsp;&nbsp;&nbsp;🚧《常用国字标准字体表》（3197 / 4808）

&nbsp;&nbsp;&nbsp;&nbsp;🚧 jf7000 当务字集基本包（3987 / 6373）
...
- 制作的衍生字体不得使用该字体的保留名称「Z工坊」和「Z Labs」，且必须同样使用 OFL-1.1 许可证发布；
